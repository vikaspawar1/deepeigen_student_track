...
export default function ReinforcementLearning() {
  ...
  return (
    <div className="min-h-screen bg-white w-full overflow-x-hidden">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 md:mb-10 lg:mb-12">
          ...
          <div className="lg:col-span-8 w-full">
            <div className="flex flex-col gap-6 w-full">
              ...
              <div className="rounded-lg md:rounded-xl border border-gray-200 px-2 md:px-3 lg:px-4 py-2 mb-3 bg-white overflow-hidden w-full">
                <div
                  className="relative flex gap-4 md:gap-6 lg:gap-8 px-1 border-b border-gray-200 overflow-x-auto scrollbar-hide"
                  ref={tabsRef}
                  style={{
                    scrollbarWidth: 'none',
