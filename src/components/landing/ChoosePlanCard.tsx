        ...
        <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 p-4 sm:p-6 md:p-8 lg:p-10   
          ...
          <div className="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-4 mb-6 sm:mb-8 border-b border-gray-400 pb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
              ...
              <div className="flex flex-row bg-white border border-gray-200 rounded-full p-1 sm:p-2 overflow-x-auto w-full sm:w-auto no-scrollbar justify-between gap-1 sm:gap-2">
                {durationOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 text-center px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold rounded-full whitespace-nowrap transition-all duration-200 cursor-pointer ${
                        isActive
